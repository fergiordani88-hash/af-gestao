...
export function ControleDespesas() {
  ...
  useEffect(() => {
    const entries = controleStorage.getEntries().filter(e => e.tipo === 'despesa')
  ...
  return (
    <ControleLayout title="Análise de Despesas" subtitle="Evolução mensal e distribuição por categoria">
