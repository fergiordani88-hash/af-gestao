...
export function ControleLancamentos() {
  ...
  const handlePagar = (e: ControleEntry) => {
    controleStorage.updateEntry(e.id, { status: 'pago', dataPag: new Date().toISOString().slice(0, 10) })
    load()
  }
  ...
  return (
    <ControleLayout title="Contas a Pagar e Receber" subtitle="Registre todos os lançamentos financeiros e controle seus vencimentos">
